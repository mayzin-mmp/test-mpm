...
function rara_business_footer_bottom(){ ?>
    <div class="footer-b">      
        <?php
            ...
            echo '<span class="by">';
            echo esc_html__( '| Developed By ', 'management-partners-myanmar' ); 
            echo '<a href="' . esc_url( 'https://rarathemes.com/' ) .'" rel="nofollow" target="_blank">' . esc_html__( '', 'software-company' ) . '</a>.';
            echo '</span>';
